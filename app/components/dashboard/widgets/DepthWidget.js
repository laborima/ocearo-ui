...
export default function DepthWidget() {
  const { getDepthData } = useOcearoContext();
    ...
    <div className="bg-oGray2 rounded-lg p-4 h-full flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        <div className="text-center mb-6">
          ...
          <div className={`text-base font-medium ${depthData.belowKeel !== null ? getDepthColor(depthData.belowKeel) : 'text-gray-500'}`}>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="text-center">
            ...
            <div className={`text-2xl font-bold ${depthData.belowKeel !== null ? getDepthColor(depthData.belowKeel) : 'text-gray-500'}`}>
          ...
          <div className="text-center">
            ...
            <div className={`text-2xl font-bold ${depthData.belowSurface !== null ? getDepthColor(depthData.belowSurface) : 'text-gray-500'}`}>
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div className="text-gray-400 text-xs w-12">{depthData.belowKeel !== null ? `${depthData.belowKeel}m` : 'N/A'}</div>
          </div>
        </div>
